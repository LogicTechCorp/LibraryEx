...
public class RecipeHelper
{
    ...
    public static IRecipe addShapedRecipe(IModData data, ItemStack result, Object... inputs)
    {
        return createShapedRecipe(data, result, inputs);
    }

    public static IRecipe addShapelessRecipe(IModData data, ItemStack result, Object... inputs)
    {
        return createShapelessRecipe(data, result, inputs);
    }
    ...
    public static IRecipe add1x2Recipe(IModData data, ItemStack result, Object input)
    {
        return addShapedRecipe(data, result, "#", "#", '#', input);
    }

    public static IRecipe add1x3Recipe(IModData data, ItemStack result, Object input)
    {
        return addShapedRecipe(data, result, "#", "#", "#", '#', input);
    }

    public static IRecipe add2x1Recipe(IModData data, ItemStack result, Object input)
    {
        return addShapedRecipe(data, result, "##", '#', input);
    }

    public static IRecipe add2x2Recipe(IModData data, ItemStack result, Object input)
    {
        return addShapedRecipe(data, result, "##", "##", '#', input);
    }

    public static IRecipe add2x3Recipe(IModData data, ItemStack result, Object input)
    {
        return addShapedRecipe(data, result, "##", "##", "##", '#', input);
    }

    public static IRecipe add3x1Recipe(IModData data, ItemStack result, Object input)
    {
        return addShapedRecipe(data, result, "###", '#', input);
    }

    public static IRecipe add3x2Recipe(IModData data, ItemStack result, Object input)
    {
        return addShapedRecipe(data, result, "###", "###", '#', input);
    }

    public static IRecipe add3x3Recipe(IModData data, ItemStack result, Object input)
    {
        return addShapedRecipe(data, result, "###", "###", "###", '#', input);
    }

    public static IRecipe addSurroundedRecipe(IModData data, ItemStack result, Object... inputs)
    {
        return addShapedRecipe(data, result, "###", "#*#", "###", '#', inputs[0], '*', inputs[1]);
    }

    public static IRecipe addCrossRecipe(IModData data, ItemStack result, Object input)
    {
        return addShapedRecipe(data, result, " # ", "###", " # ", '#', input);
    }

    public static IRecipe addFilledCrossRecipe(IModData data, ItemStack result, Object... inputs)
    {
        return addShapedRecipe(data, result, " # ", "#*#", " # ", '#', inputs[0], '*', inputs[1]);
    }

    public static IRecipe addStairRecipe(IModData data, ItemStack result, Object input)
    {
        return addShapedRecipe(data, result, "#  ", "## ", "###", '#', input);
    }

    public static IRecipe addFenceRecipe(IModData data, ItemStack result, Object... inputs)
    {
        return addShapedRecipe(data, result, "#*#", "#*#", '#', inputs[0], '*', inputs[1]);
    }

    public static IRecipe addWallRecipe(IModData data, ItemStack result, Object input)
    {
        return addShapedRecipe(data, result, "###", "###", '#', input);
    }

    public static IRecipe addSwordRecipe(IModData data, ItemStack result, Object... inputs)
    {
        return addShapedRecipe(data, result, " # ", " # ", " * ", '#', inputs[0], '*', inputs[1]);
    }

    public static IRecipe addPickaxeRecipe(IModData data, ItemStack result, Object... inputs)
    {
        return addShapedRecipe(data, result, "###", " * ", " * ", '#', inputs[0], '*', inputs[1]);
    }

    public static IRecipe addShovelRecipe(IModData data, ItemStack result, Object... inputs)
    {
        return addShapedRecipe(data, result, " # ", " * ", " * ", '#', inputs[0], '*', inputs[1]);
    }

    public static IRecipe addAxeRecipe(IModData data, ItemStack result, Object... inputs)
    {
        return addShapedRecipe(data, result, "##", "#*", " *", '#', inputs[0], '*', inputs[1]);
    }

    public static IRecipe addHoeRecipe(IModData data, ItemStack result, Object... inputs)
    {
        return addShapedRecipe(data, result, "##", " *", " *", '#', inputs[0], '*', inputs[1]);
    }

    public static IRecipe addHelmetRecipe(IModData data, ItemStack result, Object input)
    {
        return addShapedRecipe(data, result, "###", "# #", '#', input);
    }

    public static IRecipe addChestplateRecipe(IModData data, ItemStack result, Object input)
    {
        return addShapedRecipe(data, result, "# #", "###", "###", '#', input);
    }

    public static IRecipe addLeggingsRecipe(IModData data, ItemStack result, Object input)
    {
        return addShapedRecipe(data, result, "###", "# #", "# #", '#', input);
    }

    public static IRecipe addBootsRecipe(IModData data, ItemStack result, Object input)
    {
        return addShapedRecipe(data, result, "# #", "# #", '#', input);
    }

    public static IRecipe addBoatRecipe(IModData data, ItemStack result, Object input)
    {
        return addShapedRecipe(data, result, "# #", "###", '#', input);
    }
}
