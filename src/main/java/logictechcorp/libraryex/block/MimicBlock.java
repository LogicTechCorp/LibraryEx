...
public abstract class MimicBlock<T extends TileEntity> extends TileEntityBlock<T>
{
    public static final ModelProperty<BlockState> MIMIC_PROP = new ModelProperty<>();
    private final MimicType mimicType;

    public MimicBlock(MimicType mimicType, Class<T> cls, Block.Properties properties)
    {
