...
public abstract class BlockModVines extends BlockMod implements IShearable
{
    ...
    public BlockModVines(ResourceLocation registryName, BlockProperties properties)
    {
